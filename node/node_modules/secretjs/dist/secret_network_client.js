...
class SecretNetworkClient {
    ...
    broadcastTx(txBytes, timeoutMs, checkIntervalMs, mode, waitForCommit, ibcTxOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                const result = yield this.getTx(txhash);
                if (result) {
                    return result;
                }
    ...
    simulate(messages, txOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const tx_bytes = yield this.prepareAndSign(messages, txOptions);
            return service_pb_1.Service.Simulate(
            //@ts-ignore
            { tx_bytes: (0, encoding_1.toBase64)(tx_bytes) }, { pathPrefix: this.url });
        });
    }
    /**
    ...
    sign(messages, fee, memo, explicitSignerData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, wallet_amino_1.isDirectSigner)(this.wallet)) {
                return this.signDirect(accountFromSigner, messages, fee, memo, signerData);
            }
            else {
