...
export declare type DirectSigner = {
    ...
    readonly signDirect: (signerAddress: string, signDoc: import("./protobuf_stuff/cosmos/tx/v1beta1/tx").SignDoc) => Promise<DirectSignResponse>;
};
...
export declare function isOfflineDirectSigner(signer: Signer): signer is DirectSigner;
