...
export declare type ProposalContent = import("../protobuf_stuff/cosmos/gov/v1beta1/gov").TextProposal | import("../protobuf_stuff/cosmos/distribution/v1beta1/distribution").CommunityPoolSpendProposal | import("../protobuf_stuff/cosmos/params/v1beta1/params").ParameterChangeProposal | import("../protobuf_stuff/ibc/core/client/v1/client").ClientUpdateProposal | import("../protobuf_stuff/ibc/core/client/v1/client").UpgradeProposal | import("../protobuf_stuff/cosmos/upgrade/v1beta1/upgrade").SoftwareUpgradeProposal | import("../protobuf_stuff/cosmos/upgrade/v1beta1/upgrade").CancelSoftwareUpgradeProposal;
...
export declare class MsgSubmitProposal implements Msg {
    ...
    initialDeposit: Coin[];
    proposer: string;
    constructor({ type, content, initialDeposit, proposer, }: MsgSubmitProposalParams);
