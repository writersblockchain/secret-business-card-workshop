        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                encode: () => __awaiter(this, void 0, void 0, function* () {
                    return (yield Promise.resolve().then(() => __importStar(require("../protobuf_stuff/cosmos/feegrant/v1beta1/tx")))).MsgGrantAllowance.encode(this.params).finish();
                }),
            };
        });
    }
    ...
    toProto() {
        return __awaiter(this, void 0, void 0, function* () {
            return {
                ...
                value: this.params,
                encode: () => __awaiter(this, void 0, void 0, function* () {
                    return (yield Promise.resolve().then(() => __importStar(require("../protobuf_stuff/cosmos/feegrant/v1beta1/tx")))).MsgRevokeAllowance.encode(this.params).finish();
                }),
            };
        });
    }
