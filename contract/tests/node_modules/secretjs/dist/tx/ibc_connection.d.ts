...
export declare class MsgConnectionOpenInit implements Msg {
    constructor(msg: import("../protobuf_stuff/ibc/core/connection/v1/tx").MsgConnectionOpenInit);
...
export declare class MsgConnectionOpenTry implements Msg {
    constructor(msg: import("../protobuf_stuff/ibc/core/connection/v1/tx").MsgConnectionOpenTry);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
...
export declare class MsgConnectionOpenAck implements Msg {
    constructor(msg: import("../protobuf_stuff/ibc/core/connection/v1/tx").MsgConnectionOpenAck);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
...
export declare class MsgConnectionOpenConfirm implements Msg {
    constructor(msg: import("../protobuf_stuff/ibc/core/connection/v1/tx").MsgConnectionOpenConfirm);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
