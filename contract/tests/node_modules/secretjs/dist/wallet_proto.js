...
function serializeSignDoc({ accountNumber, authInfoBytes, bodyBytes, chainId, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const { SignDoc } = yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/cosmos/tx/v1beta1/tx")));
