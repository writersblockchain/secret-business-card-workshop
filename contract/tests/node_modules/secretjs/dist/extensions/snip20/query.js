...
class Snip20Querier extends __1.ComputeQuerier {
    constructor() {
        ...
        this.getTransferHistory = ({ contract, address, auth, page, page_size, }) => __awaiter(this, void 0, void 0, function* () {
            if (auth.key) {
                return yield this.queryContract({
                    contractAddress: contract.address,
                    codeHash: contract.codeHash,
        ...
        this.getTransactionHistory = ({ contract, address, auth, page, page_size, }) => __awaiter(this, void 0, void 0, function* () {
            if (auth.key) {
                return yield this.queryContract({
                    contractAddress: contract.address,
                    codeHash: contract.codeHash,
