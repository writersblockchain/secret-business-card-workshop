...
const mainnetConsensusIoPubKey = (0, encoding_1.fromHex)("083b1a03661211d5a4cc8d39a77795795862f7730645573b2bcc2c1920c53c04");
const mainnetChainIds = new Set(["secret-2", "secret-3", "secret-4"]);
class EncryptionUtilsImpl {
    constructor(registrationQuerier, seed, chainId) {
    ...
    getConsensusIoPubKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { key } = yield this.registrationQuerier.txKey({});
...
function extractPubkey(cert) {
    ...
    try {
        // Try SW mode
        const pubkey = (0, encoding_1.fromBase64)((0, encoding_1.fromUtf8)(payload));
        if (pubkey.length === 32) {
            return pubkey;
        }
    }
    ...
    try {
        ...
        const quoteHex = (0, encoding_1.fromBase64)(JSON.parse((0, encoding_1.fromUtf8)((0, encoding_1.fromBase64)(JSON.parse((0, encoding_1.fromUtf8)(payload)).report)))
            .isvEnclaveQuoteBody);
...
function extractAsn1Value(cert, oid) {
    let offset = (0, encoding_1.toHex)(cert).indexOf((0, encoding_1.toHex)(oid)) / 2;
