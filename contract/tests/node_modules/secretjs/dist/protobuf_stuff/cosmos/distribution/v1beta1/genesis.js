...
exports.ValidatorOutstandingRewardsRecord = {
    ...
    fromPartial(object) {
        ...
        message.outstandingRewards =
            ((_b = object.outstandingRewards) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        return message;
    },
};
    ...
    fromJSON(object) {
        return {
            ...
            startingInfo: isSet(object.startingInfo)
                ? distribution_1.DelegatorStartingInfo.fromJSON(object.startingInfo)
                : undefined,
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            feePool: isSet(object.feePool)
                ? distribution_1.FeePool.fromJSON(object.feePool)
                : undefined,
    ...
    toJSON(message) {
        ...
        if (message.validatorAccumulatedCommissions) {
            obj.validatorAccumulatedCommissions =
                message.validatorAccumulatedCommissions.map((e) => e ? exports.ValidatorAccumulatedCommissionRecord.toJSON(e) : undefined);
        }
        else {
            obj.validatorAccumulatedCommissions = [];
        }
