...
export declare const MsgGrantAllowance: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgGrantAllowance;
...
export declare const MsgGrantAllowanceResponse: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgGrantAllowanceResponse;
...
export declare const MsgRevokeAllowance: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgRevokeAllowance;
...
export declare const MsgRevokeAllowanceResponse: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgRevokeAllowanceResponse;
