...
export declare const MsgSubmitEvidence: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgSubmitEvidence;
...
export declare const MsgSubmitEvidenceResponse: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): MsgSubmitEvidenceResponse;
