...
exports.ClientUpdateProposal = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.initialHeight !== undefined) {
            exports.Height.encode(message.initialHeight, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.initialHeight = exports.Height.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            initialHeight: isSet(object.initialHeight)
                ? exports.Height.fromJSON(object.initialHeight)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.initialHeight !== undefined &&
            (obj.initialHeight = message.initialHeight
                ? exports.Height.toJSON(message.initialHeight)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.initialHeight =
            object.initialHeight !== undefined && object.initialHeight !== null
                ? exports.Height.fromPartial(object.initialHeight)
                : undefined;
        return message;
    },
};
