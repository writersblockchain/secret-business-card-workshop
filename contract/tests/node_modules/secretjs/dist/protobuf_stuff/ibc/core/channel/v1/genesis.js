...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            nextChannelSequence: isSet(object.nextChannelSequence)
                ? String(object.nextChannelSequence)
                : "0",
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.sendSequences =
            ((_e = object.sendSequences) === null || _e === void 0 ? void 0 : _e.map((e) => exports.PacketSequence.fromPartial(e))) || [];
        message.recvSequences =
            ((_f = object.recvSequences) === null || _f === void 0 ? void 0 : _f.map((e) => exports.PacketSequence.fromPartial(e))) || [];
        message.ackSequences =
            ((_g = object.ackSequences) === null || _g === void 0 ? void 0 : _g.map((e) => exports.PacketSequence.fromPartial(e))) || [];
