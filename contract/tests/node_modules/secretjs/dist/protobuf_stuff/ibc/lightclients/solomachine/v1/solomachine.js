...
exports.ClientState = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.frozenSequence = longToString(reader.uint64());
                    break;
                case 3:
    ...
    toJSON(message) {
        ...
        message.frozenSequence !== undefined &&
            (obj.frozenSequence = message.frozenSequence);
    ...
    fromPartial(object) {
        ...
        message.frozenSequence = (_b = object.frozenSequence) !== null && _b !== void 0 ? _b : "0";
    ...
    fromJSON(object) {
        return {
            ...
            newPublicKey: isSet(object.newPublicKey)
                ? any_1.Any.fromJSON(object.newPublicKey)
                : undefined,
    ...
    fromJSON(object) {
        return {
            newPubKey: isSet(object.newPubKey)
                ? any_1.Any.fromJSON(object.newPubKey)
                : undefined,
            newDiversifier: isSet(object.newDiversifier)
                ? String(object.newDiversifier)
                : "",
